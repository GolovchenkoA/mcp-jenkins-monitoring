 ...
 * @param authEnvVar the name of the environment variable that holds the credentials; only set for a usable
 *                   server, because for a rejected one the value may be a credential pasted by mistake
